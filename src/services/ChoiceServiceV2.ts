import type { ChoiceLineV2, LineStatus } from '@/types/script-v2'
import type { NavigationServiceV2 as NavigationServiceV2Type, GameStateV2 } from './NavigationServiceV2'
...
export class ChoiceServiceV2 {
  ...
  async handleChoice(
    ...
    // 更新选中状态
    const lineIndex = this.displayState.displayedLines.findIndex(l => l.id === lineId)
